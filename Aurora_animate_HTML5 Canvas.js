...
lib.ssMetadata = [
		{name:"Aurora_animate_HTML5 Canvas_atlas_1", frames: [[0,252,366,51],[0,189,366,61],[0,0,557,61],[0,63,557,61],[0,126,557,61]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(260.65,320,1,1,0,0,0,140,225);

	this.instance_4 = new lib.StageOutline("synched",0);
	this.instance_4.setTransform(1000.65,319.8,1,1,0,0,0,140,225);

	this.instance_5 = new lib.StageOutline("synched",0);
	this.instance_5.setTransform(628.2,320,1,1,0,0,0,140,225);

	this.instance_6 = new lib.CachedBmp_5();
	this.instance_6.setTransform(860.75,40.8,0.5,0.5);

	this.instance_7 = new lib.CachedBmp_4();
	this.instance_7.setTransform(490.75,40.8,0.5,0.5);

	this.instance_8 = new lib.CachedBmp_3();
	this.instance_8.setTransform(121.45,41.1,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6}]},1).wait(205));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(758.7,400.8,383.5,269.2);
// library properties:
lib.properties = {
